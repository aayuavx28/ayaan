...
TELEGRAM_BOT_TOKEN = '7853606151:AAGtrZanSQjicQ05Tv97QjOVg_6HmRn-4rY'
ADMIN_USER_ID = 7355703826 
...
async def attack(update: Update, context: CallbackContext):
    ...
    if not is_user_allowed(user_id):
        await context.bot.send_message(chat_id=chat_id, text="❌ **Bina key ke kaise use karega meri Jaan🥹!** BHAI access to lele 🥹 dm - @Trusted_Seller_008.", parse_mode='Markdown')
        return
    ...
    await context.bot.send_message(chat_id=chat_id, text=( 
        ...
        f"Sit back and enjoy our Gaamd faad DDOS!"
    ), parse_mode='Markdown')
...
async def add_user(update: Update, context: CallbackContext):
    ...
    if user_id_sender != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="❌ **Access Denied!** BKL tu admin hai kya jo users add karega chutiye .", parse_mode='Markdown')
        return
...
async def remove_user(update: Update, context: CallbackContext):
    ...
    if user_id_sender != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="❌ **Access Denied!** Tu Admin hai kya bhadwe 🌝.", parse_mode='Markdown')
        return
